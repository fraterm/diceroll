...
std::string
parseDiceString (std::string diceString)
{
  long numThrows = 1;
  long numDice = 1;
  long numSides = 6;
...
int
rollDice (long sides, long quantity)
{
